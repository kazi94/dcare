            ...
            <b-container fluid id="printMe" style="display : none">
                ...
                <b-row class=" mb-2 mt-1 ml-2">
                    <b-col>
                        ...
                        <p>
                            <strong>Téléphone :</strong> {{ patient.num_tel }}
                        </p>
                    </b-col>
...
const options1 = {
    ...
    styles: ["/plugins/bootstrap-5.0.0-beta3-dist/css/bootstrap.min.css"]
};
